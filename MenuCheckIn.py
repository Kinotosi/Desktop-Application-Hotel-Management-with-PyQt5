...
class Ui_ChekIn(object):
    def setupUi(self, Form):
        ...
        self.LabelTittle.setGeometry(QtCore.QRect(-20, 0, 741, 51))
        font = QtGui.QFont()
        ...
        self.LogoTitle.setGeometry(QtCore.QRect(620, 10, 41, 31))
...
"}")
    ...
    def retranslateUi(self, Form):
        ...
        self.LabelTittle.setText(_translate("Form", "FORM CHECK IN HOTEL MELATI"))
