...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.LogoAkun.setPixmap(QtGui.QPixmap("img/uji.png"))
...
"color: rgb(255, 255, 255);")
        ...
        self.TitleService.setGeometry(QtCore.QRect(0, 80, 271, 41))
        font = QtGui.QFont()
...
"background: transparent;")
        ...
        self.LogoUser.setPixmap(QtGui.QPixmap("img/man.png"))
...
"}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/logout.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.LogoGen.setPixmap(QtGui.QPixmap("img/gender.png"))
...
"}")
        ...
        self.LogoBooking.setPixmap(QtGui.QPixmap("img/booking.png"))
...
"}")
        ...
        self.LogoCheckIn.setPixmap(QtGui.QPixmap("img/checkin.png"))
...
"}")
        ...
        self.LogoDaftar.setPixmap(QtGui.QPixmap("img/Daftar.png"))
...
"}")
        ...
        self.LogoCheckOut.setPixmap(QtGui.QPixmap("img/checkout.png"))
    ...
    def retranslateUi(self, Form):
        ...
        self.TitleHotel.setText(_translate("Form", "Hotel Melati"))
        ...
        self.TitleDaftar.setText(_translate("Form", "Daftar Tamu"))
    ...
    def PopUpLogOut(self):
        ...
        msg.setWindowTitle("Log Out Hotel Melati")
