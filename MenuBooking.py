...
class Ui_Booking(object):
    def setupUi(self, Form):
        ...
        self.LabelTittle.setGeometry(QtCore.QRect(60, 0, 861, 51))
        font = QtGui.QFont()
        ...
        self.LogoTitle.setGeometry(QtCore.QRect(710, 10, 41, 31))
...
"}")
    ...
    def clickedSubmit(self):
        ...
        cur.execute(query4, (id_transaksi+1, id_tamu+1, self.FormNoKamar.text(), '20'+YearIn+"-"+MonthIn+"-"+DayIn, '20'+YearOut+"-"+MonthOut+"-"+DayOut, harga))
        ...
        self.ReloadData()
        self.show_message("Submit Tamu", "Data tamu sudah tersubmit")
